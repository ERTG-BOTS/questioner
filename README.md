...
- ⏰ Автоматическое отслеживание неактивности
...
- ⏲️ Таймеры неактивности с предупреждениями
...
# Система таймеров неактивности
ACTIVITY_STATUS=True
ACTIVITY_WARN_MINUTES=5    # Предупреждение о неактивности
ACTIVITY_CLOSE_MINUTES=10  # Автозакрытие при неактивности
```
