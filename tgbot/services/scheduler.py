...
async def remove_question_timer(
    bot: Bot, question: Question, questions_repo: RequestsRepo
):
    ...
    scheduler.add_job(
        ...
        args=[bot, question, questions_repo],
        id=warning_job_id,
    )


async def remove_question(bot: Bot, question: Question, questions_repo: RequestsRepo):
