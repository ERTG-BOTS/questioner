...
class Question(Base, TableNameMixin):
    ...
    def __repr__(self):
        return f"<Question {self.token} {self.topic_id} {self.topic_duty_fullname} {self.employee_fullname} {self.employee_chat_id} {self.question_text} {self.start_time} {self.end_time} {self.clever_link} {self.quality_employee} {self.quality_duty} {self.status} {self.allow_return} {self.activity_status_enabled}>"
